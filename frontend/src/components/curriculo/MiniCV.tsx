...
export default function MiniCV() {
    return (
       ...
       items-center md:items-center lg:items-center xl:items-start bg-black border border-zinc-800 rounded-2xl px-6 pt-6">
            ...
            <div className="flex flex-col gap-5 self-center py-6 items-center md:items-start lg:items-center xl:items-start">
                ...
                text-transparent bg-clip-text text-2xl font-bold">Kathryn Oliveira</span>
                <span>Desenvolvedora Full Stack</span>
                </div>
                <p className="text-sm text-center md:text-left lg:text-center xl:text-left">Lorem Ipsum é simplesmente uma simulação de
                     texto da indústria tipográfica e de impressos, e vem 
